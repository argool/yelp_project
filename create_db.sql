...
CREATE TABLE businesses (
    ...
    is_open boolean,
    attributes json, -- an array of strings: each array element is an attribute
    categories json -- an array of strings of business categories
);
...
CREATE TABLE users (
    ...
    friends json, -- ideally, friendship would be a separate table, but populating that table takes too long
